...
import EmptyWishbagScreen from '../../App/Components/EmptyWishbagScreen'

const wrapper = shallow(<EmptyWishbagScreen />)
...
test('component structure', t => {
  ...
  t.true(wrapper.children().first().containsMatchingElement('EmptyWishbagScreen Component')) // That the Component Text is included
})
