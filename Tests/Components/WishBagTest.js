...
import WishBag from '../../App/Components/WishBag'

const wrapper = shallow(<WishBag />)
...
test('component structure', t => {
  ...
  t.true(wrapper.children().first().containsMatchingElement('WishBag Component')) // That the Component Text is included
})
