...
import TossableCard from '../../App/Components/TossableCard'

const wrapper = shallow(<TossableCard />)
...
test('component structure', t => {
  ...
  t.true(wrapper.children().first().containsMatchingElement('TossableCard Component')) // That the Component Text is included
})
